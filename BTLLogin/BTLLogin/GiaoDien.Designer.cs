namespace BTLLogin
{
	partial class GiaoDien
	{
		...
		private void InitializeComponent()
		{
			...
			this.button2.Text = "&Hợp đồng lao động";
			this.button2.UseVisualStyleBackColor = true;
			// 
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(418, 56);
			this.button3.Name = "button3";
			this.button3.Size = new System.Drawing.Size(161, 50);
			this.button3.TabIndex = 2;
			this.button3.Text = "&Khen thưởng / Kỷ luật";
			this.button3.UseVisualStyleBackColor = true;
			// 
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(608, 56);
